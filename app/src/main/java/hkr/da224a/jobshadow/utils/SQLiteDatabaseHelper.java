...
public class SQLiteDatabaseHelper extends SQLiteOpenHelper {
    ...
    public boolean addStudent(Student student) {
        student.setDateCreated(new Timestamp(Calendar.getInstance().getTime().getTime()));
        ...
        values.put(COLUMN_STUDENT_DATE_CREATED, student.getDateCreated().toString());
    ...
    public boolean addBusiness(Business business) {
        business.setDateCreated(new Timestamp(Calendar.getInstance().getTime().getTime()));
        SQLiteDatabase db = this.getWritableDatabase();
    ...
    public void updateOfferId(NotificationsSettings notificationsSettings) {
        SQLiteDatabase db = this.getWritableDatabase();

...
import hkr.da224a.jobshadow.activities.offer_activities.BusinessEditActivity;
import hkr.da224a.jobshadow.fragments.Adapters.ViewPagerAdapter;
import hkr.da224a.jobshadow.fragments.BusinessDetailFragment;
...
public class BusinessProfileActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        editButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(BusinessProfileActivity.this, BusinessEditActivity.class);
    ...
    private void setupViewPager(ViewPager viewPager) {
        ...
        viewPagerAdapter.addFragment(new BusinessDetailFragment(), "Details");
